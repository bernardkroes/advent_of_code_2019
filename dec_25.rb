...
the_input_codes = File.read("dec_25_input.txt").chomp.split(",").map(&:to_i)
the_robot = IntComp.new(the_input_codes, [])

# part 1
# some walking around to collect all the things that do not kill
the_robot_inputs = []
the_robot_inputs << "inv"
the_robot_inputs << "north"
the_robot_inputs << "take tambourine"
the_robot_inputs << "east"
the_robot_inputs << "take astrolabe"
the_robot_inputs << "south"
the_robot_inputs << "take shell"
the_robot_inputs << "north"
the_robot_inputs << "east"
the_robot_inputs << "north"
the_robot_inputs << "take klein bottle"
the_robot_inputs << "north"
the_robot_inputs << "take easter egg"
the_robot_inputs << "south"
the_robot_inputs << "south"
the_robot_inputs << "west"
the_robot_inputs << "west"
the_robot_inputs << "south"
the_robot_inputs << "south"
the_robot_inputs << "south"
the_robot_inputs << "take hypercube"
the_robot_inputs << "north"
the_robot_inputs << "north"
the_robot_inputs << "west"
the_robot_inputs << "take dark matter"
the_robot_inputs << "west"
the_robot_inputs << "north"
the_robot_inputs << "west"
the_robot_inputs << "take coin"
the_robot_inputs << "south"

# manually trying the combos
# the_robot_inputs << "drop tambourine"
the_robot_inputs << "drop shell"
# the_robot_inputs << "drop dark matter"
# the_robot_inputs << "drop coin"
the_robot_inputs << "drop easter egg"
the_robot_inputs << "drop astrolabe"

# only one of these two:
the_robot_inputs << "drop klein bottle"
# the_robot_inputs << "drop hypercube"
